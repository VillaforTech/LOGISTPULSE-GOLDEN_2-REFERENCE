...
REQUESTS = Counter('logistpulse_http_requests_total', 'HTTP requests', ['service', 'method', 'path', 'status'])
LATENCY = Histogram('logistpulse_http_request_duration_seconds', 'HTTP latency', ['service', 'path'])
